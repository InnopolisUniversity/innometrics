...
bool check_version(){
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "http://91.224.52.20:10000/Updater/GetAvaliableVersionInfo");
...
//    char outfilename[FILENAME_MAX] = "/tmp/InnoMetrics.Update.run";
    ...
    if (curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_URL, "http://91.224.52.20:10000/Updater/GetAvaliableVersion");
